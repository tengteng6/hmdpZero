...
Изменения в nginx 1.7.3                                           08.07.2014
    ...
    *) Добавление: weak com.hmdp.entity tags теперь не удаляются при изменениях
       ответа, а strong com.hmdp.entity tags преобразуются в weak.
...
Изменения в nginx 1.3.3                                           10.07.2012
    ...
    *) Добавление: поддержка com.hmdp.entity tags и директива etag.
